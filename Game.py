...
def DrawWalls(wallcolor):
    ...
    pygame.draw.rect(canvas,wallcolor,(0, 0, width, 10)) #top wall
    pygame.draw.rect(canvas,wallcolor,(0, 0, 10, height)) #left wall
    pygame.draw.rect(canvas,wallcolor,(width - 10, 0, 10, height)) #right wall
    pygame.draw.rect(canvas,wallcolor,(0, height - 10, width, 10)) #bottom wall
...
def ShowVision_Area(vision_list):
    for x in vision_list:
        #pygame.draw.rect(canvas,white,(x[0], x[1], snake_block, snake_block))
